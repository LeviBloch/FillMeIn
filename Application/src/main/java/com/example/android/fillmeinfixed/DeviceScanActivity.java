...
public class DeviceScanActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // added by me to try to make this work
...
//        startActivityForResult(enableLocationIntent, 2);
        ...
        // testing zone ----------------------------------------------------------------------------
//        MessageDeliveryJobIntentService.enqueueWork(getApplicationContext(), new Intent());
//        MorseCodeTranslator morseCodeTranslator = new MorseCodeTranslator(this);
//        Log.d("human morse code", morseCodeTranslator.convertTextToReadableMorse( "Penis Music always!"));
//        Log.d("morse code", morseCodeTranslator.convertTextToMorse( "Penis Music always!"));
    }
    @Override
